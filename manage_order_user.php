        ...
        <h1 class="titledashboard">Manage Order</h1>
                ...
                <table class="tbl-full">
                    ...
                    <?php 
                        ...
                        $sql = "SELECT order_id,food.food_name,quantity,total_price,order_date,
                        customer.contact_number,address,status from orders,food,customer
                        where orders.customer_id=customer.customer_id and orders.food_id=food.food_id and customer.customer_id='$id' 
                            ...
                            while($row=mysqli_fetch_assoc($res))
                            {
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo ""; ?>cancel_order_user.php?order_id=<?php echo $id; ?>" class="btn-secondary">Cancel Order</a>
                                        </td>
                                    </tr>
